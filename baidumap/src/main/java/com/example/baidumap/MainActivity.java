    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_item_mylocation://返回当前位置
                Log.d("panzqww","myLatitude = "+myLatitude);
                Log.d("panzqww","myLongitude = "+myLongitude);
                myLatitude = 22.5422870000;
                myLongitude = 113.9804440000;
...
//                        Toast.makeText(context, "", Toast.LENGTH_SHORT).show();
            ...
            case R.id.menu_item_sitesearch://根据地址搜索
                ...
                myEditText_site.setText("江西省樟树市");
